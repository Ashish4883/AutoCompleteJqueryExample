...
namespace AutoCompleteJqueryExample.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public string FilteredList(string city)
        {
            city = city + "%";
            SqlCommand cmd = new SqlCommand("select name from Cities where name like '" + city + "'", con);
